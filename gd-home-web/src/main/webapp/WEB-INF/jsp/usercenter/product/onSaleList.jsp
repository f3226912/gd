...
<body>
   ...
   <jsp:include page="../userCenter_left.jsp" flush="true"/> 
		...
		<div class="mid-right mid-right-bor">
			<h1 class="mid-right-store">销售中的产品</h1>
			<div id="tab">
				<ul class="tab_menu">
			    	<li class="selected">销售中的产品</li>
			    </ul> 
					...
					<div class="tab_box" style="background:white;">
						<div class="tab_box-cet">
							...
							<c:if test="${page==null || empty page.pageData }">
									<p style="margin: 50px 0; text-align: center; font-size: 14px;">官人，还没有已上架的产品哦！</p>
								</c:if>
								...
								<table class="tab-gridtable">
									...
									<tbody id="allOffTBody">
										<tr>
											...
											<td style="color:#e21313">已上架</td>
											<td>
												<a href="javascript:void(0);" onclick="edit('${product.productId}')" >修改</a>/
												<a class="i-shelves" href="javascript:void(0);" pId="${product.productId}">下架</a>
										...
										<tr>
											<th colspan="7">
												<div class="tab-ang-lt">
													...
													<a class="tab-ang-lt-del" href="javascript:void(0);" onclick="batchUpdate(4)">下架</a>
												</div>
											</th>
										</tr>
									</tfoot>
	...
	<%-- 								<input type="hidden" id="sort" name="sort" value="${param.sort}">
					...
					<input type="hidden" id="chargeType" name="chargeType" value="3">
