		...
		<div class="getpwd-box">
			...
			<div class="tab-cntent">
				...
				<div class="reg-result-box">
					<h3 class="com-result-t"><span class="result-ico-succ"></span>恭喜您，密码设置成功！</h3>
					<p>您下次可使用新密码登录谷登农批网。您现在可以<a href="${CONTEXT}login/initLogin" class="reg-r-link">登录</a>或进入<a href="${CONTEXT}index" class="reg-r-link">谷登农批网首页</a></p>
				</div>
			</div>
