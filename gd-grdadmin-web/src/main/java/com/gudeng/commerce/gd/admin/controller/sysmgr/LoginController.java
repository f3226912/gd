...
import com.gudeng.commerce.gd.admin.util.CookieUtil;
import com.gudeng.commerce.gd.admin.util.LoginUserUtil;
import com.gudeng.commerce.gd.admin.util.MessageUtil;
...
public class LoginController {
	private final GdLogger logger = GdLoggerFactory.getLogger(LoginController.class);
	...
	public String login(HttpServletRequest request, HttpServletResponse response) {
		if (LoginUserUtil.getLoginUserId(request) != null) {
			return "redirect:" + PathUtil.getBasePath(request) + "sysIndex";
		}
