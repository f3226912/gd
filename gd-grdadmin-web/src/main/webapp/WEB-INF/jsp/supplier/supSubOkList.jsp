...
<body>
	...
	<div id="supSubtb" style="padding:5px;height:auto">
		...
		<div>
			...
			<br/>
			<gd:btn btncode='BTNGYSYBT01'><a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#supSubSearchForm').form('validate');">查询</a></gd:btn>
		...
		<div style="margin-bottom:5px;text-align: left;">
			<a class="easyui-linkbutton" iconCls="icon-reload" id="icon-refresh">刷新</a>
 			<gd:btn btncode='BTNGYSYBT02'><a id="exportData" class="easyui-linkbutton" iconCls="icon-save">导出数据</a></gd:btn>
		</div>
	</div>
</body>
<script>
