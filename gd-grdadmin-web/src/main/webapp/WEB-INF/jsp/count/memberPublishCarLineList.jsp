...
<body>
	...
	<div id="countCarLinetb" style="padding:5px;height:auto">
		<form id="countCarLineSearchForm" method="post">
			...
			<gd:btn btncode='BTNXXTJGXXLFBTJ01'><a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#countCarLineSearchForm').form('validate');">查询</a></gd:btn>
			<a class="easyui-linkbutton icon-reload-btn" iconCls="icon-reload" id="btn-reset">重置</a>
			<a class="easyui-linkbutton" iconCls="icon-reload" id="icon-refresh">刷新</a>
			<gd:btn btncode='BTNXXTJGXXLFBTJ02'><a id="exportData" class="easyui-linkbutton" iconCls="icon-save">导出数据</a></gd:btn>
		</form>
	</div>
</body>
<script type="text/javascript" src="${CONTEXT}js/count/main.js"></script>
</html>
