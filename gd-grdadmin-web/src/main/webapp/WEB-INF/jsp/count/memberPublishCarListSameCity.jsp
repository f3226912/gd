...
<body>
	...
	<div id="countCartb" style="padding:5px;height:auto">
		<form id="countCarSearchForm" method="post">
			...
			<gd:btn btncode='BTNXXTJTCCLFBTJ01'><a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#countCarSearchForm').form('validate');">查询</a></gd:btn>
			<a class="easyui-linkbutton icon-reload-btn" iconCls="icon-reload" id="btn-reset">重置</a>
			<a class="easyui-linkbutton" iconCls="icon-reload" id="icon-refresh">刷新</a>
			<gd:btn btncode='BTNXXTJTCCLFBTJ02'><a id="exportData" class="easyui-linkbutton" iconCls="icon-save">导出数据</a></gd:btn>
		</form>
	</div>
</body>
<script type="text/javascript" src="${CONTEXT}js/count/car_same_city.js"></script>
</html>
