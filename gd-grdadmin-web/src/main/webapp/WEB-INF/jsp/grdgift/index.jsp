...
<body>
	...
	<div id="dataGridToolbar" style="padding:5px;height:auto">
		...
		<div>
			...
			class="easyui-numberbox easyui-validatebox" style="width:150px" >&nbsp;&nbsp;
			礼品名称：
			<input type="text" id="name" placeholder="礼品名称"
			class="easyui-validatebox" name="name" style="width:150px" >&nbsp;&nbsp;
			<gd:btn btncode='BTNDTLPGLCX01'>
			<a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#dataGridSearchForm').form('validate');" >查询</a>
			</gd:btn>
