        ...
        <div title="用户信息">	
			...
			<table>
				<tr>
					...
					<td class="mright">
						<input  type="text" id="realName"  name="realName"   value="${dto.realName}" required="true" class="easyui-validatebox" style="width:150px" >
					</td>
				</tr>
				<tr>
					<td class="mleft" >
					...
					手机号:</td>
					<td class="mright">
						<input  type="text"  id="mobile" value="${dto.mobile}"  required="true"   class="easyui-validatebox"  name="mobile"     style="width:150px" >
					</td>
				</tr>
				<tr>
					<td class="mleft" >
...
<%--  	    		<input type="hidden" id="memberIdMore" name="memberId"    value="${dto.memberId}"/>
 --%>				<input type="hidden" id="level" name="level"    value="${dto.level}"/>
	    		 企业经营信息：
				<table>
					<tr>
