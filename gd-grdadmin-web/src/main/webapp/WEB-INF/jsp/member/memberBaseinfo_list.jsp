...
<!-- 							<option value="0">请选择</option>
 -->
			...
			<gd:btn btncode='BTNHYGLHYLB05'><a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#memberSearchForm').form('validate');"    >查询</a></gd:btn>&nbsp;&nbsp;
...
/* 		 var queryParams = $('#memberdg').datagrid('options').queryParams;
			...
			var paramList = "account=" + params.account + "&mobile="+params.mobile+"&level="+params.level+"&isAuth="+params.isAuth+
