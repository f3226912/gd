...
<body>
	...
	<div id="carstb" style="padding:5px;height:auto">
		...
		<div style="margin-bottom:5px">
			<gd:btn btncode='BTNGXWLXXGLCLXXGL02'><a class="easyui-linkbutton icon-add-btn" iconCls="icon-add" id="icon-add" >新增</a></gd:btn>
			<gd:btn btncode='BTNGXWLXXGLCLXXGL03'><a class="easyui-linkbutton icon-edit-btn" iconCls="icon-edit" id="icon-edit" >编辑</a></gd:btn>
			<gd:btn btncode='BTNGXWLXXGLCLXXGL04'><a class="easyui-linkbutton icon-remove-btn" iconCls="icon-remove" id="icon-remove">删除</a></gd:btn>
...
function optformat(value,row,index){
	return "<gd:btn btncode='BTNGXWLXXGLCLXXGL06'><a class='operate' href='javascript:;' onclick=delObj('"+row.id+"');>删除</a></gd:btn>";
}
