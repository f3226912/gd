...
<form id="save-form" method="post" action="grdProPersonalAuth/save">
	...
	<div>
		<table style="border: none;width: 100%;">
			...
			<tr>
				...
				<td><input type="text" id="auditor" name="auditor" value="${dto.auditor}" required="true" class="easyui-validatebox" validType="unnormal" missingMessage="auditor必填" style="width: 90%;"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="applyTime" name="applyTime" value="${dto.applyTime}" required="true" class="easyui-validatebox" validType="unnormal" missingMessage="applyTime必填" style="width: 90%;"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="auditTime" name="auditTime" value="${dto.auditTime}" required="true" class="easyui-validatebox" validType="unnormal" missingMessage="auditTime必填" style="width: 90%;"></td>
			</tr>
			<tr>
