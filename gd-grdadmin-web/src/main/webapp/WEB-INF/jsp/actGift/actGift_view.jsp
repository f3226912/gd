...
<div style="width:300px; height:100px; margin:20px auto">
	<table>
		<tr>
			...
			<td>可用库存：</td>
			<td><input type="text" name="stockTotal" value="${dto.stockAvailable }" disabled="disabled"></td>
		</tr>
		</tr>
			<td>创建时间：</td>
			<td><input type="text" name="stockTotal" value="<fmt:formatDate value='${dto.createTime }' pattern='yyyy-MM-dd HH:mm:ss'/>" disabled="disabled"></td>
		</tr>
		</tr>
			<td>创建人：</td>
