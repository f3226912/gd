...
<body>
	...
	<div id="membertb" style="padding:5px;height:auto">
		...
		目的地县区:<input name="end_areaId" id="end_areaId"
					style="width: 174px;" class="easyui-validatebox"></br>
			<gd:btn btncode='BTNTCWLXXGLFHXXJL01'><a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#memberSearchForm').form('validate');"    >查询</a></gd:btn>&nbsp;&nbsp;
			<a class="easyui-linkbutton icon-reload-btn" iconCls="icon-reload" id="btn-reset">重置</a> &nbsp;&nbsp;
		    <a class="easyui-linkbutton" iconCls="icon-reload" id="icon-refresh">刷新</a> &nbsp;&nbsp;
 			<gd:btn btncode='BTNTCWLXXGLFHXXJL02'><a id="exportData" class="easyui-linkbutton" iconCls="icon-save">导出数据</a></gd:btn>
		</div>
		</form>
...
function optFormat(value,row,index){
	return "<gd:btn btncode='BTNTCWLXXGLFHXXJL03'><a class='operate' href='javascript:;' onclick=showObj('"+row.memberId+"');>查看</a></gd:btn>" ;
}
</script>
...
<script type="text/javascript">
    ...
    queryParams.transportType =$('#memberSearchForm #transportType').val();
		...
		window.location.href=CONTEXT+'publishAddress/exportDataSameCity?account='+queryParams.account+
