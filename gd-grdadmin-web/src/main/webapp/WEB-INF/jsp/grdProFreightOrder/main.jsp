...
<body>
<table id="grdProFreight-datagrid-table" title=""></table>
<div id="grdProFreight-datagrid-tool-bar" style="height:auto;padding:0px !important;margin:0px;">
	<form id="grdProFreight-datagrid-form" method="post">
	<table>
		<tr>
			...
			<td>
			<input type="text" id="grdUserName" name="grdUserName" placeholder="请输入姓名" maxlength="30" class="easyui-validatebox" style="width:170px;height:20px;margin-right: 10px;" >
			</td>
		...
		<tr>
			...
			<td>
				<input  type="text"  id="startGenerateTime" name="startGenerateTime"  onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'endGenerateTime\')}'})"    onClick="WdatePicker({maxDate:'#F{$dp.$D(\'endGenerateTime\')}'})"    style="width:75px;" />
				—
				<input  type="text"  id="endGenerateTime" name="endGenerateTime"   onFocus="WdatePicker({minDate:'#F{$dp.$D(\'startGenerateTime\')}'})"   onClick="WdatePicker({minDate:'#F{$dp.$D(\'startGenerateTime\')}'})"   style="width:75px;margin-right: 10px;"/> 
	...
	<div style="background:#efefef;padding:5px;height:25px;">
			<div style="float: left;font-size:16px;margin-left:5px;">货运订单列表</div>
			<gd:btn btncode='BTNHYDDTJDC01'><div style="float:right;margin-right:57px;"><a id="exportData" class="easyui-linkbutton" iconCls="icon-save">导出数据</a></div></gd:btn>
	</div>
</div>
</body>
...
<script type="text/javascript" src="${CONTEXT}js/grdProFreightOrder/main.js"></script>
</html>