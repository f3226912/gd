...
<div id="datagrid-tool-bar" style="padding:5px;height:auto">
	...
	<div>
		敏感词：
		<input type="text" id="words" name="words" placeholder="敏感词" class="easyui-validatebox" style="width:150px" >
		过滤时间：
...
<!-- 		<input type="text" id="createTime" name="createTime"  class="easyui-validatebox" style="width:150px" >
 -->		<!-- type：
...
$("#exportData").click(function(){
	...
	var words = $('#datagrid-form #words').val();
	...
	$.ajax({
		url: CONTEXT+'sensitiveLog/checkExportParams',
		data : params,
		type:'post',
		success : function(data){
			...
			if (data && data.status == 1){
				...
				if (!disableExport){
					...
					disableExport = true ;
					//启动下载
					$.download(CONTEXT+'sensitiveLog/exportData',paramList,'post' );
				}else{
...
<script type="text/javascript" src="${CONTEXT}js/sensitiveLog/main.js"></script>
</html>