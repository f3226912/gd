...
<body>
	...
	<div id="appVersiontb" style="padding:5px;height:auto">
		<form id="appVersionSearchForm" method="post">
			<div>
				...
				<select name="type" id="appType" style="width: 150px;">
					...
					<option value="3">产地供应</option>
					<option value="4">农速通</option>
					<option value="5">谷登铁军</option>
		...
		<div id="editAppVersionDialog" class="easyui-dialog" style="width:800px;height:500px;" closed="true" modal="true" buttons="#dlg-buttonsEdit">
		...
		<div id="detailAppVersionDialog" class="easyui-dialog" style="width:800px;height:500px;" closed="true" modal="true" buttons="#dlg-buttonsDetail">
		...
		<div id="proAppVeresionDialog" class="easyui-dialog" style="width:800px;height:500px;" closed="true" modal="true" buttons="#dlg-buttonsPro">
...
function editObj(id){
	$('#editAppVersionDialog').dialog({'title':'编辑数据','href':CONTEXT+'app/editinit?id='+id, 'width': 800,'height': 500}).dialog('open');	
}
...
$(document).ready(function(){
	...
	$('#icon-add').click(function(){
		$('#addAppVersionDialog').dialog({'title':'新增数据','href':CONTEXT+'app/addinit', 'width': 800,'height': 500}).dialog('open');
	});
