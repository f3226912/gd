...
<html>
	...
	<script>
		...
		function assignRole(id){
			$('#assignRoleDialog').dialog({'title':'分配角色',"width": 800,"height":450,'href':CONTEXT+'sysmgr/sysUserRole/assignUserList?userID='+id}).dialog('open');
			$('#dg').datagrid("uncheckAll");
		}
	...
	<table id="dg" title="">
		<thead>
			<tr>
				...
				<th data-options="field:'userCode',width:80,align:'left',sortable:true">用户帐号</th>
				<th data-options="field:'userName',width:80,align:'left',sortable:true">用户名称</th>
				<th data-options="field:'mobile',width:80,align:'left',sortable:true">联系电话</th>
				<th data-options="field:'locked',width:50,align:'center',formatter: function(value){if(value=='0')return '<font color=green>启用</font>';if(value=='1')return '<font color=red>禁 用</font>';},sortable:true">用户状态</th>
<!-- 				<th data-options="field:'typeName',width:50,align:'left',sortable:true">类型</th> -->
				<th data-options="field:'total',width:60,align:'center',sortable:true,formatter:hasRoleFormatter">是否已分配角色</th>
<!-- 				<th data-options="field:'orgUnitName',width:80,align:'left',sortable:true">所属组织</th> -->
<!-- 				<th data-options="field:'createTime',width:100,align:'center',sortable:true">创建时间</th> -->
				<th data-options="field:'action',width:80,align:'center',formatter:updateOperate">操作</th>
			</tr>
		</thead>
	</table>
...
<%-- 			<c:if test="${typeList.size()>1 }"> --%>
<!-- 			用户类型: -->
<!-- 			<select class="easyui-combobox" id="type" name="type" editable="false" panelHeight="auto" style="width:100px"> -->
<!-- 				<option value="">请选择</option> -->
