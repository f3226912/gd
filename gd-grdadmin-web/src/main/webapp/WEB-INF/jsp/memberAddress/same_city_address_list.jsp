...
<body>
	<table id="same_city_addressdg" title="">
	</table>
	<div id="same_city_addresstb" style="padding:5px;height:auto">
		<form id="same_city_addressSearchForm" method="post">
		<div>
			 发货人: 
		 ...
		 <input  type="text" id="cityName"  name="cityName"  style="width:150px" >&nbsp;&nbsp;
          ...
          <option  value="1">已删除</option>
			...
			<gd:btn btncode='BTNTCWLXXGLHYXXGL01'><a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#same_city_addressSearchForm').form('validate');"    >查询</a></gd:btn>&nbsp;&nbsp;
		...
		<div style="margin-bottom:5px">
			<a class="easyui-linkbutton" iconCls="icon-reload" id="icon-refresh">刷新</a>
         	<gd:btn btncode='BTNTCWLXXGLHYXXGL02'><a id="exportData" class="easyui-linkbutton" iconCls="icon-save">导出数据</a></gd:btn>
...
function optformat(value,row,index){
	 return "<gd:btn btncode='BTNTCWLXXGLHYXXGL03'><a class='operate' href='javascript:;'onclick=editObj('"+row.id+"');>修改</a></gd:btn>&nbsp;" +
	 "<gd:btn btncode='BTNTCWLXXGLHYXXGL04'><a class='operate' href='javascript:;' onclick=delObj('"+row.id+"');>删除</a></gd:btn>";
}
</script>
<script type="text/javascript" src="${CONTEXT}js/memberAddress/sameCityAddress.js"></script>
