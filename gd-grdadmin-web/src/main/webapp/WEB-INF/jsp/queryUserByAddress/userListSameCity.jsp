...
<body>
	...
	<div id="usertb" style="padding:5px;height:auto">
		...
		目的地县区:<input name="end_areaId" id="end_areaId"
			...
			<gd:btn btncode='BTNXXTJTCHYFBTJ01'><a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#userSearchForm').form('validate');">查询</a></gd:btn>&nbsp;&nbsp;
		...
		<div style="margin-bottom:5px">
			...
			<gd:btn btncode='BTNXXTJTCHYFBTJ02'><a id="exportData" class="easyui-linkbutton" iconCls="icon-save">导出数据</a></gd:btn>
		</div>
		
	</div>
</body>
<script type="text/javascript" src="${CONTEXT}js/queryUserByAddress/user_same_city.js"></script>
