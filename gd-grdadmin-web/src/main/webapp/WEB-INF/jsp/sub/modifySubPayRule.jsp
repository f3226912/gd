...
<script type="text/javascript" src="${CONTEXT}js/sub/modifyRule.js"></script>
<style type="text/css">
...
<form id="addForm" method="post" action="2">
			...
			<table class="tableaddr" >
				...
				<tr>
					...
					<input  type="hidden" id="subRuleId"  name="subPayRule.ruleId"   value="${rule.ruleId}">
					</td>
				</tr>
				<tr>
					<td class="mleft"  >
				...
				<tr>
					...
					<td class="mright">
					订单交易成交金额&nbsp;&nbsp;<input  type="text" id="subPercent"  onkeyup="clearNoNum(this)"   name="subPercent" <fmt:formatNumber value="${rule.subPercent/1000 }" var="subPercent" pattern="0.0#"/>   value="${subPercent }" maxlength="20"   style="width:50px" >&nbsp;%
...
<c:if test="${rule.subType eq 4 }">
	<c:forEach var="item" items="${rule.ranges}" varStatus="status">				
				<tr class="rangcn" >
					...
					<td class="mright">
					<input  type="text" id="minOrderAmount0"  onkeyup="clearNoNum(this)"   name="rList[${status.index}].lowerLimit"   value="${item.lowerLimit }"  maxlength="20"  style="width:100px">&nbsp;元
					--
					<input  type="text" id="orderAmount0"  onkeyup="clearNoNum(this)"   name="rList[${status.index}].upperLimit"   value="${item.upperLimit }"  maxlength="20"  style="width:100px">&nbsp;元
 					</td>
 					<td  class="mright">
 					补贴金额&nbsp;&nbsp;<input  type="text" id="subAmount0"  onkeyup="clearNoNum(this)"   name="rList[${status.index}].subAmount"   value="${item.subAmount }" maxlength="20"   style="width:70px" >&nbsp;
...
<c:if test="${rule.subType ne 4 }">	
				<tr class="rangcn" >
					...
					<td class="mright">
					<input  type="text" id="minOrderAmount0"  onkeyup="clearNoNum(this)"   name="rList[0].lowerLimit"   value=""  maxlength="20"  style="width:100px">&nbsp;元
					--
					<input  type="text" id="orderAmount0"  onkeyup="clearNoNum(this)"   name="rList[0].upperLimit"   value=""  maxlength="20"  style="width:100px">&nbsp;元
 					</td>
 					<td  class="mright">
 					补贴金额&nbsp;&nbsp;<input  type="text" id="subAmount0"  onkeyup="clearNoNum(this)"   name="rList[0].subAmount"   value="" maxlength="20"   style="width:70px" >&nbsp;
...
<c:if test="${rule.subType eq 5 }">				
	<c:forEach var="item" items="${rule.ranges}" varStatus="status">					
				<tr class="rangmg">
					...
					<td class="mleft">
 					补贴金额&nbsp;&nbsp;<input  type="text" id="subAmount0"  name="mList[${status.index}].subAmount"   onkeyup="clearNoNum(this)"   value="${item.subAmount }" maxlength="20"   style="width:70px" >&nbsp;
...
<%-- <c:if test="${rule.subType ne 5 }">	
				<tr class="rangmg">
					...
					<td class="mleft">
 					补贴金额&nbsp;&nbsp;<input  type="text" id="subAmount0"  onkeyup="clearNoNum(this)"   name="mList[0].subAmount"   value="" maxlength="20"   style="width:70px" >&nbsp;
...
<c:if test="${rule.subType eq 3 }">								
	<c:forEach var="item" items="${rule.ranges}" varStatus="status">
				<tr class="cu179" >
					...
					<td class="mright">
					<input  type="text" id="minOrderAmount0"  name="zList[${status.index}].lowerLimit"  onkeyup="clearNoNum(this)"    value="${item.lowerLimit }"  maxlength="20"  style="width:70px">&nbsp;
					--
					<input  type="text" id="orderAmount0"  name="zList[${status.index}].upperLimit"  onkeyup="clearNoNum(this)"    value="${item.upperLimit }"  maxlength="20"  style="width:70px">&nbsp;
					...
					<select id="u181r" name="zList[${status.index}].unit">
 					...
 					<td  class="mright">
 					补贴金额&nbsp;&nbsp;<input  type="text" id="subAmount0"  name="zList[${status.index}].subAmount"  onkeyup="clearNoNum(this)"    value="${item.subAmount }" maxlength="20"   style="width:70px" >&nbsp;
...
<c:if test="${rule.subType ne 3 }">	
		<tr class="cu179" >
				...
				<tr>
					...
					<td class="mright">
					&nbsp;&nbsp;每笔订单补贴&nbsp;&nbsp;<input  type="text" id="subAmount"  name="subPayRule.subAmount"  onkeyup="clearNoNum(this)"    value="${rule.subAmount }" maxlength="20"  style="width:50px" >&nbsp;元
				...
				<tr>
					...
					<td class="mright">
					POS刷卡&nbsp;&nbsp;<input  type="text"  onkeyup="clearNoNum(this)"  id=""  name="posCoefficient" <fmt:formatNumber value="${rule.posCoefficient/1000 }" var="pos"  pattern="0.0#"/>  value="${pos }" maxlength="20"   style="width:50px" >&nbsp;

 					</td>
					<td class="mright">
					余额支付&nbsp;&nbsp;<input  type="text"  onkeyup="clearNoNum(this)"  id=""  name="walletCoefficient" <fmt:formatNumber value="${rule.walletCoefficient/1000 }" var="wallet"  pattern="0.0#"/>  value="${wallet }" maxlength="20"   style="width:50px" >&nbsp;

 					</td>
					<td class="mright">
					现金支付&nbsp;&nbsp;<input  type="text" id=""  onkeyup="clearNoNum(this)"   name="cashCoefficient" <fmt:formatNumber value="${rule.cashCoefficient/1000 }" var="cash" pattern="0.0#"/>  value="${cash }" maxlength="20"   style="width:50px" >&nbsp;
			...
			<div id="dlg-buttonsAdd" style="text-align:center">
	            ...
	            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:parent.$('#editDialog').window('close')">关闭</a>
	        </div>   		
 	</div>	
</form>
 	...
 	$("#u165_input").change(function(){
 		window.location.href = CONTEXT + 'subpayrule/editRule/${rule.ruleId}?marketId=' + $(this).val();
