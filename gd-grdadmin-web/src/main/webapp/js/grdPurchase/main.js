...
function loadList(params){
	...
	$('#purchase_datagrid-table').datagrid({
		...
		columns:[[
		    ...
		    {field:'purchaseNO1',title:'采购单编号',width:100,align:'left',formatter : updateOrview},
			{field:'marketName',title:'所属市场',width:100,align:'left'},
			{field:'warehouseName',title:'所属仓库',width:100,align:'left'},
			{field:'orderamount',title:'订单总金额',width:100,align:'left'},
			{field:'createTime',title:'订单创建时间',width:100,align:'center'},
			{field:'status',title:'状态',width:100,align:'center',formatter: formatStatus},
			{field:'purchaser',title:'采购申请人',width:100,align:'left'},
