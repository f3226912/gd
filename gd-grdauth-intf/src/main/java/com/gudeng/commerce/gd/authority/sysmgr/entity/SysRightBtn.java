...
public class SysRightBtn implements java.io.Serializable {
	...
	/** full constructor */
	public SysRightBtn(String id, String roleId, String userId, String btnId, String createUserId, Timestamp createTime, String updateUserId, Timestamp updateTime) {
		this.id = id;
		this.roleId = roleId;
		this.userId = userId;
		this.btnId = btnId;
