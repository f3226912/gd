...
public class BusinessBaseinfoToolServiceImpl implements BusinessBaseinfoToolService{ 
	...
	public BusinessBaseinfoDTO getBusinessShortInfoBySearch(Map<String, Object> params) throws Exception {
		return getHessianBusinessBaseinfoService().getBusinessShortInfoBySearch(params);
	}

	@Override
	public Map<String, Object> getCertifForBusinessBySearch(Map<String, Object> params) throws Exception {
		return getHessianBusinessBaseinfoService().getCertifForBusinessBySearch(params);
	}
