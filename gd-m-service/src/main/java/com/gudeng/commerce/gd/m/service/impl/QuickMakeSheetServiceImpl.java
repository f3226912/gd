...
public class QuickMakeSheetServiceImpl implements com.gudeng.commerce.gd.m.service.QuickMakeSheetService {
	...
	public Integer productCount(Map<String, Object> map) throws Exception {
		...
		return getHessianOrderCommentService().productCount(map);
	}
