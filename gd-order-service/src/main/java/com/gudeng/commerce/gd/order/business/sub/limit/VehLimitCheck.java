 ...
 * @date 2015年12月2日 下午8:01:20
 */
public class VehLimitCheck extends ACheckRule {
	...
	protected String dayRangeValid(Map map, SubRangeLimitRuleDTO rultDTO) throws ServiceException {
		...
		Integer dailySubOutmarket = (Integer) map.get("dailySubOutmarket");
	    Integer getCount = rultDTO.getCount();
	    String result1 = "OK";
	    if(dailySubOutmarket.compareTo(getCount) < 0){//可以补贴
	    	return result1;
	    }else{                                       //不满足条件
	    	result1 = "";
	    	return result1;
	...
	protected String weekRangeValid(Map map, SubRangeLimitRuleDTO rultDTO) throws ServiceException {
		// TODO Auto-generated method stub
		Integer weeklySubOutmarket = (Integer) map.get("weeklySubOutmarket");
	    Integer getCount = rultDTO.getCount();
	    String result2 = "OK";
	    if(weeklySubOutmarket.compareTo(getCount) < 0){//可以补贴
	    	return result2;
	    }else{                                       //不满足条件
	    	result2 = "";
	    	return result2;
	...
	protected String monthRangeValid(Map map, SubRangeLimitRuleDTO rultDTO) throws ServiceException {
		// TODO Auto-generated method stub
		Integer monthlySubOutmarket = (Integer) map.get("monthlySubOutmarket");
	    Integer getCount = rultDTO.getCount();
	    String result3 = "OK";
	    if(monthlySubOutmarket.compareTo(getCount) < 0){//可以补贴
	    	return result3;
	    }else{                                       //不满足条件
	    	result3 = "";
	    	return result3;
