...
/**
	...
	*/
	...
	public String getGrdProCallstatisticsServiceUrl() {
		return properties.getProperty("gd.grdProCallstatisticsService.url");
	}
	public String getMemberChangeLogUrl() {
		return properties.getProperty("gd.memberChangeLogService.url");
	}
	public String getPvStatisticBusinessUrl() {
		return properties.getProperty("gd.pvStatisticBusinessService.url");
	}
	public String getMemberPageStatisticUrl() {
		return properties.getProperty("gd.memberPageStatisticService.url");
	}
	public String getInvoiceInfoUrl(){
		return properties.getProperty("gd.invoiceInfoService.url");
	}
	public String getAppactivitystatServiceUrl() {
		return properties.getProperty("gd.appactivitystatService.url");
	}
	
	/** memberMessageFlagService 的地址 */
	public String getMemberMessageFlagUrl() {
		return properties.getProperty("gd.memberMessageFlagService.url");
	}

	public String getGdActActivityServiceUrl() {
		return properties.getProperty("gd.gdActActivityService.url");
	}

	public String getGdActActivityMarketServiceUrl() {
		return properties.getProperty("gd.gdActActivityMarketService.url");
	}

	public String getGdActActivityUserRuleServiceUrl() {
		return properties.getProperty("gd.gdActActivityUserRuleService.url");
	}

	public String getGdActActivityRulesServiceUrl() {
		return properties.getProperty("gd.gdActActivityRulesService.url");
	}

	public String getGdActActivityParticipationRuleServiceUrl() {
		return properties.getProperty("gd.gdActActivityParticipationRuleService.url");
	}

	public String getGdActActivityDistributionModeServiceUrl() {
		return properties.getProperty("gd.gdActActivityDistributionModeService.url");
	}
	public String getOrderFeeItemDetailServiceUrl() {
		return properties.getProperty("gd.orderFeeItemDetailService.url");
	}
	public String getBankInformationServiceUrl() {
		return properties.getProperty("gd.bankInformationService.url");
	}
	...
	public String getPayCenterUrl() {
		return properties.getProperty("gd.payCenter.url");
	}

	public String getGdOrderActivityBaseServiceUrl() {
		return properties.getProperty("gd.gdOrderActivityBaseService.url");
	}
	public String getOrderRefundRecordServiceUrl() {
		return properties.getProperty("gd.orderRefundRecordService.url");
	}

	public String getNstApiUrl() {
		return properties.getProperty("gd.nstOrderPlatformLogService.url");
	}

	public String getPayCenterRefundUrl() {
		return properties.getProperty("gd.payCenterRefundAmtService.url");
	}
	public String getOrderActRelationServiceUrl() {
		return properties.getProperty("gd.orderActRelationService.url");
	}
	
	public String getNpsOfferPriceServiceUrl() {
		return properties.getProperty("gd.npsOfferPriceService.url");
	}
	public String getNpsPurchaseServiceUrl() {
		return properties.getProperty("gd.npsPurchaseService.url");
	}

	public String getActUserIntegralChangeServiceUrl() {
		return properties.getProperty("gd.actUserIntegralChangeService.url");
	}
}
