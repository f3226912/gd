...
public class ReBusinessPosToolServiceImpl implements ReBusinessPosToolService {
	...
	@Override
	public int updateByOriNewPosNum(Map<String,String> paraMap) throws Exception {
		return getHessianReBusinessPosService().updateByOriNewPosNum(paraMap);
	}
	...
	public List<ReBusinessPosDTO> getNewReBusinessPosByBusinessId(Long businessId) throws Exception {
		return getHessianReBusinessPosService().getNewReBusinessPosByBusinessId(businessId);
	}
