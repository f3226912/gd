...
public class MemberBaseinfoToolServiceImpl implements MemberBaseinfoToolService {
	...
	public int getGoldSupplierTotal(Map map) throws Exception {
		return getHessianMemberBaseinfoService().getGoldSupplierTotal(map);
	}
	...
	public List<MemberBaseinfoDTO> queryGoldSupplierbySearch(Map map) throws Exception {
		return getHessianMemberBaseinfoService().queryGoldSupplierbySearch(map);
	}
	...
	public List<MemberBaseinfoDTO> getBuyerListForGdActivity(Map<String, Object> map) throws Exception {
		return getHessianMemberBaseinfoService().getBuyerListForGdActivity(map);
	}
	
	@Override
	public MemberBaseinfoDTO getMemberTonken(String memberId) throws Exception {
		return getHessianMemberBaseinfoService().getMemberTonken(memberId);
	}
}
