...
function addSend(v) {
	...
	html = html.replace("#link",CONTEXT+"transfer/showSendTranDetail/"+v.id+"/"+fromCode+"?orderNo="+orderNoF+"&userId="+userIdF);
...
function addOther(v) {
	...
	case 1:
		link= CONTEXT+"transfer/showWfTranDetail/"+v.nobId+"/"+fromCode+"?orderNo="+orderNoF+"&userId="+userIdF;
		break;
	case 2:
		link= CONTEXT+"transfer/showFTranDetail/"+v.nobId+"/"+fromCode+"?orderNo="+orderNoF+"&userId="+userIdF;
		break;
	case 3:
		link= CONTEXT+"transfer/showFoTranDetail/"+v.nobId+"/"+fromCode+"?orderNo="+orderNoF+"&userId="+userIdF;
		break;
	case 4:
		link= CONTEXT+"transfer/showufTranDetail/"+v.nobId+"/"+fromCode+"?orderNo="+orderNoF+"&userId="+userIdF;
		break;
	case 5:
		link= CONTEXT+"transfer/showufTranDetail/"+v.nobId+"/"+fromCode+"?orderNo="+orderNoF+"&userId="+userIdF;
		break;
	default:
		link= CONTEXT+"transfer/showSendTranDetail/"+v.nobId+"/"+fromCode;
		break;
	}
