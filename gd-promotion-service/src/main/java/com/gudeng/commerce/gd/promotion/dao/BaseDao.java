package com.gudeng.commerce.gd.promotion.dao;
...
public interface BaseDao<T> {
     ...
     * @return 查询结果集
     */
    <E> QueryResult<E> pageQuery(String countSqlId, String pageSqlId, 
