...
卡长度一般为15-20位
			...
			<tr>
				...
				<td><input type="text" id="bankSignId" name="bankSignId"  value="${dto.bankSignId}" required="true" class="easyui-validatebox" validType="unnormal" missingMessage="发卡行标识取值必填" style="width: 200px;"><span>
				请输入发卡主账号头几位</span></td>
			</tr>
			<tr>
				<td><span style="color: red">*</span>发卡行标识长度：</td>
				<td><input type="text" id="bankSignLength" name="bankSignLength"  value="${dto.bankSignLength}" required="true" class="easyui-validatebox" validType="unnormal" missingMessage="发卡行标识长度必填" style="width: 200px;"></td>
			</tr>
			<tr>
