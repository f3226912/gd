...
.user-iteam{margin-left:-18px;}
.error-status{margin-top:25px;}
</style>
			...
			<table>
				...
				<tr>
					...
					<td align="left" colspan="3"><input id="name" name="name"
						type="text" class="widget easyui-validatebox" required="true" validType="unnormal"
						maxlength="30" missingMessage="礼品名称不能为空且不能有空格" value="${dto.name }"
									...
									<div class="user-iteam">
										...
										<div class="form-context">
											...
											<ul id="pictureShowFirst" class="multPic-box multPic-ul"
												style="height: 120px;">
												<c:if test="${not empty dto.giftImages and imgCount>0 and not empty dto.giftImages[0]}">
									...
									<div class="user-iteam">
										...
										<div class="form-context">
											...
											<ul id="pictureShowSecond" class="multPic-box multPic-ul"
												style="height: 120px;">
												<c:if test="${not empty dto.giftImages and imgCount>1 and not empty dto.giftImages[1]}">
