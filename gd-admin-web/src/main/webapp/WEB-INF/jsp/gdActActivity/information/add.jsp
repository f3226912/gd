...
<script type="text/javascript" src="${CONTEXT}js/gdActActivity/information/add.js"></script>
<style>
table {
		...
		<form id="userRule" method="post" action="#">
			<table style="width: 700px;">
				...
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span id="addprod_span"><input type="button" value="添加商品" onclick="addProd();" id="addProdBT" disabled="disabled"  /></span>&nbsp;</td>
				...
				<div id="buyerLayer" style='border: solid 1px #E6DDDD; width: 740px;'>
					<table id="buyer_tb_comm">
						...
						<tr>
							...
							<input type="hidden" name="buyer" value="3" tag="0" id="orderAmtCertRadio" />
						...
						<tr id="template_id" value="0">
							<td colspan="2" style=" padding: 5px;">
								<div style="margin-left:3px; border: solid 1px #E6DDDD;">
									...
									&nbsp;&nbsp;&nbsp;
									<input type="radio" value="1" name="buyer_order_id" id="orderFixedRadio" tag="0" onclick="disabledTrue(this)"/>按固定金额<input id="fixedAmt" name="buyerFixedAmt_id" type="text" style="width: 60px;" disabled />元/商品ID
									<c:if test="${empty view }">
					...
					<div style="padding: 8px;">
					保底佣金:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="width: 60px;" id="buyerAmt" name="buyerAmt" value=""/>&nbsp;&nbsp;元/单
					</div>
				</div>
				<h2>卖家佣金设置</h2>
						...
						<tr id="template_id" value="0">
							<td colspan="2" style=" padding: 5px;">
								<div style="margin-left:3px; border: solid 1px #E6DDDD;">
									...
									&nbsp;&nbsp;&nbsp;
									<input type="radio" value="1" name="solder_order_id" id="orderFixedRadio" tag="0"  onclick="disabledTrue(this)" />按固定金额<input type="text" id="fixedAmt" name="solderFixedAmt_id"  style="width: 60px;" disabled/>元/商品ID
									<c:if test="${empty view }">
						...
						<tr id="template_id" value="0">
							<td colspan="2" style=" padding: 5px;">
								<div style="margin-left:3px; border: solid 1px #E6DDDD;">
									...
									&nbsp;&nbsp;&nbsp;
									<input type="radio" value="1" name="solder_order1_id" id="orderFixedRadio" tag="0"  onclick="disabledTrue(this)" />按固定金额<input type="text" id="fixedAmt" name="solderFixedAmt1_id"  style="width: 60px;" disabled/>元
									<c:if test="${empty view }">
...
<c:if test="${not empty activity}">
	...
	<script type="text/javascript" src="${CONTEXT}js/gdActActivity/information/initedit.js"></script>
</c:if>