...
<body>
	...
	<div id="certifitb" style="padding:5px;height:auto">
		...
		<div>
			...
			商铺所属市场：
			<select name="marketId" id="marketId" class="easyui-combobox">
			...
			<br/>
			手机号码:
			<input  type="text" id="mobile" name="mobile" class="easyui-validatebox" style="width:150px" >
			<gd:btn btncode='BTNHYGLSPRZ02'>
 				<a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#certifiSearchForm').form('validate');">查询</a>
			</gd:btn>&nbsp;&nbsp;
