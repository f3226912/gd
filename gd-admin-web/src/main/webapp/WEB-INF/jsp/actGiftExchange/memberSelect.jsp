...
function optFormatter(value,row,index){
	return "<a class='operate' href='javascript:;' onclick=\"selectMemberCallBack("+row.memberId+",'"+row.account+"');\">选择</a>";
}
...
function memberCallBack(index,row){
	...
	$("#addActGiftExchangeForm #showMemberDailog").val(row.account);
	$("#addActGiftExchangeForm #memberId").val(memberId);
	$('#memberDailog').dialog('close');
}
function selectMemberCallBack(memberId,account){
	$("#addActGiftExchangeForm #showMemberDailog").val(account);
	$("#addActGiftExchangeForm #memberId").val(memberId);
	$('#memberDailog').dialog('close');
}
</script>