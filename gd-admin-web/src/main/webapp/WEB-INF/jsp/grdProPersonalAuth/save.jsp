	...
	<div>
		<table style="border: none;width: 100%;">
			...
			<tr>
				...
				<td><input type="text" id="auditor" name="auditor"  value="" required="true" class="easyui-validatebox" validType="unnormal" missingMessage="auditor必填" style="width: 90%;"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="applyTime" name="applyTime"  value="" required="true" class="easyui-validatebox" validType="unnormal" missingMessage="applyTime必填" style="width: 90%;"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="auditTime" name="auditTime"  value="" required="true" class="easyui-validatebox" validType="unnormal" missingMessage="auditTime必填" style="width: 90%;"></td>
			</tr>
			<tr>
