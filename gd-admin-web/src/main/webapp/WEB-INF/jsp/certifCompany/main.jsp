...
<div id="datagrid-tool-bar" style="padding:5px;height:auto">
	...
	<div>
		...
		<br>
		企业名称：
		<input type="text" id="companyName" name="companyName" placeholder="公司名称" class="easyui-validatebox" style="width:150px" >
		认证状态：
...
$("#exportData").click(function(){
	...
	var companyName = $('#datagrid-form #companyName').val();
	...
	//var paramList = 'createTime=' + createTime + '&status=' + status +'&updateTime=' + updateTime +'&companyName=' + companyName +'&optionUser=' + optionUser +'&bzl=' + bzl +'&id=' + id +'&updateUserId=' + updateUserId +'&commitTime=' + commitTime +'&account=' + account +'&memberId=' + memberId +'&appType=' + appType +'&bzlPhotoUrl=' + bzlPhotoUrl +'&createUserId=' + createUserId;

	$.ajax({
		url: CONTEXT+'certifCompany/checkExportParams',
		data : params,
		type:'post',
		success : function(data){
			...
			if (data && data.status == 1){
				...
				if (!disableExport){
					...
					disableExport = true ;
					//启动下载
					$.download(CONTEXT+'certifCompany/exportData',paramList,'post' );
				}else{
...
<script type="text/javascript" src="${CONTEXT}js/certifCompany/main.js"></script>
</html>