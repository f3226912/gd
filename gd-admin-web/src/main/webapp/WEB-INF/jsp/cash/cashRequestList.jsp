...
<body>
	...
	<div id="cashtb" style="padding:5px;height:auto">
		<form id="cashSearchForm" method="post">
			...
			<input  type="hidden"  id="payBeginTime" name="payBeginTime"
				...
				style="width:150px" >
			<input  type="hidden"    id="payEndTime" name="payEndTime"
			...
			<gd:btn btncode='BTNTXGLTXSQGL03'><a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#cashSearchForm').form('validate');">查询</a>&nbsp;&nbsp;</gd:btn>
			<a class="easyui-linkbutton icon-reload-btn" iconCls="icon-reload" id="btn-reset">重置</a>
			<a class="easyui-linkbutton" iconCls="icon-reload" id="icon-refresh">刷新</a>
			<gd:btn btncode='BTNTXGLTXSQGL01'><a id="exportData" class="easyui-linkbutton" iconCls="icon-save">导出数据</a></gd:btn>
		</form>
	</div>
	<div id="accountFlowListDialog" class="easyui-dialog" style="width:600px;height:220px;" closed="true" modal="true" buttons="#accountFlowList">
		<div id="accountFlowList" style="text-align:center">
	...
	<div id="payDialog" class="easyui-dialog" style="width:600px;height:220px;" closed="true" modal="true" buttons="#">
