...
$("#exportData").click(function(){
	...
	$.ajax({
		url: CONTEXT+'appactivitystat/checkExportParams?appType=7',
		data : params,
		type:'post',
		success : function(data){
			...
			if (data && data.status == 1){
				...
				if (!disableExport){
					...
					disableExport = true ;
					//启动下载
					$.download(CONTEXT+'appactivitystat/exportData?appType=7',params,'post' );
				}else{
...
<script type="text/javascript" src="${CONTEXT}js/appactivitystat/nst.js"></script>
</html>