...
<div id="datagrid-tool-bar" style="padding:5px;height:auto">
	...
	<div>
		...
		<br>
		基地名称：
		<input type="text" id="baseName" name="baseName" placeholder="" class="easyui-validatebox" style="width:150px" >
		认证状态：
...
$(function(){
	gudeng.certif.base.initList();
	//查询按钮
	$('#btn-search').click(function(){
		gudeng.certif.base.query();
	});

	//刷新按钮
	$('#btn-refresh').click(function(){
		gudeng.certif.base.refresh();
	});

	//重置按钮
	$('#btn-reset').click(function(){
		gudeng.certif.base.reset();
	});
	...
	$("#exportData").click(function(){
		...
		$.ajax({
			url: CONTEXT+'certifBase/checkExportParams',
			data : params,
			type:'post',
			success : function(data){
				...
				if (data && data.status == 1){
					if (!disableExport){
						...
						disableExport = true ;
						//启动下载
						$.download(CONTEXT+'certifBase/exportData',paramList,'post' );
					}else{
...
<script type="text/javascript" src="${CONTEXT}js/certifBase/main.js"></script>
</html>