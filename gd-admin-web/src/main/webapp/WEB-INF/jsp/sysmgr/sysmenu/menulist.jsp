...
<!-- 	<div data-options="region:'north'" style="height:100px"> -->
		<div id="tb" style="padding:5px;height:auto">
			...
			<div>
	            ...
	            searcher:function(value,name){query2(value,name)}">&nbsp;&nbsp;&nbsp;&nbsp;
	 			菜单级别: <select id="level" name="level" >
...
<!--             <div data-options="region:'west',expand:true" style="width:180px"> -->
            ...
            <table id="dg" title="">
				<thead>
					<tr>
						...
						<th data-options="field:'menuCode',width:80,align:'left',sortable:true">菜单编号</th>
						<th data-options="field:'menuName',width:80,align:'left',sortable:true">菜单名称</th>
						<th data-options="field:'parentMenuName',width:80,align:'left',sortable:true">上级菜单</th>
						<th data-options="field:'actionUrl',width:100,align:'left'">菜单Url</th>
						<th data-options="field:'sort',width:50,align:'center'">排序</th>
						<th data-options="field:'level',width:50,align:'center',formatter: levelformater">菜单级别</th>
