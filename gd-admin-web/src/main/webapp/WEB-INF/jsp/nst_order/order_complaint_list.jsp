...
<body>
	<table id="nstOrderComplaintdg" title="">
	</table>
	<div id="nstOrderComplainttb" style="padding:5px;height:auto">
		<form id="nstOrderComplaintSearchForm" method="post">
		<div>
			运单号: 
			...
			<%-- <gd:btn btncode='BTNHYGLNSTRZ03'> --%><a class="easyui-linkbutton icon-search-btn" iconCls="icon-search" id="icon-search" OnClick ="return $('#nstOrderComplaintSearchForm').form('validate');"    >查询</a>&nbsp;&nbsp;
		...
		<div id="showDialog" class="easyui-dialog" style="width:600px;height:220px;" closed="true" modal="true" buttons="#dlg-buttonsShow">
			<div id="dlg-buttonsShow" style="text-align:center">
				<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" id="icon-back-btn" onclick="updateStatus();$('#showDialog').dialog('close')" >提交</a>
...
<script type="text/javascript" src="${CONTEXT}js/nst_order/order_complaint.js"></script>
</html>
