...
<script type="text/javascript">
	...
	<div class="munebg" width="100%"><span color="">设置：${marketDTO.marketName }</span>-${pcDTO.cateName}-关联基础分类</div>
...
<!-- 				<iframe align="top" id="products" width="100%" height="300px;" style="border:0"></iframe> -->
<!-- 			</td> -->
		</tr>
	</table>
</body>
