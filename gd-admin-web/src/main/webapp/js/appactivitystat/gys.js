...
function loadList(params){
	...
	$('#datagrid-table').datagrid({
		...
		columns:[[
			...
			{field:'managementtype',title:'经营类型',width:100,align:'center',formatter:formatterManagementtype },
			{field:'categoryName',title:'主营分类',width:100,align:'center' },
...
function formatterManagementtype(val, row) {
	if (val != null) {
		var  str=val.toString();
		if(str=="1"){
			return "种养大户";
