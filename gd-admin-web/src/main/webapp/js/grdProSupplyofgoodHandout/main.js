...
gudeng.goodsHandout.loadList = function(params){
	...
	$('#datagrid-table').datagrid({
		...
		columns:[[
			...
			{field:'sourceType',title:'线路类型',width:80,align:'center',halign:'center',formatter : gudeng.goodsHandout.sourceTypeformat},
			{field:'publisher',title:'发布人姓名',width:100,align:'left',halign:'center'},
			{field:'mobile',title:'发布人手机',width:120,align:'center',halign:'center'},
...
gudeng.goodsHandout.sourceTypeformat = function (val,row,index){
	if (val == '1') {
		return "干线";
	}else if(val == '2'){
		return '同城';
