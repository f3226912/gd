	...
	public void exportData(HttpServletRequest request, HttpServletResponse response){
		...
		try {
			...
			if (wwb != null) {
				...
				Label label10 = new Label(1, 0, "已发放礼品数");// 填充第一行第一个单元格的内容
				Label label20 = new Label(2, 0, "当前库存 ");// 填充第一行第二个单元格的内容
				Label label30 = new Label(3, 0, "可用库存 ");// 填充第一行第四个单元格的内容
				Label label40 = new Label(4, 0, "创建时间");// 填充第一行第五个单元格的内容
				Label label50 = new Label(5, 0, "添加人");// 填充第一行第七个单元格的内容
				...
				if (list != null && list.size() > 0) {
					for (int i = 0, len = list.size(); i < len; i++) {
						...
						Label label1 = new Label(0, i + 1, dto.getCountApply()+"");
						Label label2 = new Label(2, i + 1, dto.getStockTotal()+"");
						Label label3 = new Label(3, i + 1, dto.getStockAvailable()+"");
						Label label4 = new Label(4, i + 1, DateUtil.getDate(dto.getCreateTime(), DateUtil.DATE_FORMAT_DATETIME));
						Label label5 = new Label(5, i + 1, dto.getCreateUserName());
