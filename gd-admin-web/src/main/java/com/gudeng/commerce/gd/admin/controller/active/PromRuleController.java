...
public class PromRuleController extends AdminBaseController{

	private final GdLogger logger = GdLoggerFactory.getLogger(PromRuleController.class);
	
	@Resource
	private PromRuleFeeToolService promRuleFeeToolService;
	
	@RequestMapping("toRule")
	public String list(){
		return "active/promRule";
	}
