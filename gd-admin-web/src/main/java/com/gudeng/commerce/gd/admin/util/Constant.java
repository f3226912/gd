...
public class Constant {
    ...
    /**
     * @Fields SYSTEM_BUTTON 用户所用有的按钮权限集合
     * @since Ver 1.0
     */
    ...
    *  每一个EXCEL表格的会员条数
    */
    public static final int EXCEL_SIZE = 50000;//
  /**
   * EXCEL零时目录
   */
    public static final String TEMP_EXCEL_PATH=File.separator+"data"+File.separator+"temp"+File.separator+"execleTemp";
