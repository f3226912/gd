...
public class MailUtil {
	...
	private static String HOST = "smtp.gdeng.cn";
	private static String USER = "gdsystem@gdeng.cn";
	private static String PASSWORD = "xHpwGcH8";
	...
	public static void main(String[] args) {
		...
		TOMail.add("kxiong@gdeng.cn");
		TOMail.add("wwji@gdeng.cn");
		CCMail.add("dli@gdeng.cn");
		BCCMail.add("bdhuang@gdeng.cn");
