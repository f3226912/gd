 ...
 * @since [产品/模块版本]
 */
public class SubLimitRuleTask extends AbstractTask<Boolean> {

	@Resource(name = "subLimitRuleExecuteService")
	private ExecuteService executeService;

	private static final Logger LOGGER = LoggerFactory.getLogger(SubLimitRuleTask.class);
