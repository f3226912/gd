...
public class DateUtil  extends DateUtils {
	 ...
	 * @return
	 */
	public static String getTimeBySubHour(int hour) {
	 ...
	 * @return
	 */
	public static String getTimeBySubDay(int day){
		Calendar calendar = Calendar.getInstance();
	...
	public static void main(String[] args) {
		System.out.println(getTimeBySubHour(-3));
		
		System.out.println(getTimeBySubDay(-3));
	}
}
