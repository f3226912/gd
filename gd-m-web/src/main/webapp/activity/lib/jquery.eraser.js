			...
			return this.each(function(){
				...
				if ( !data ) {
					var width = _width,
						...
						beforeFunction = ( options && options.beforeFunction )?options.beforeFunction:null,
						parts = [],
					...
					ctx.drawImage( this, 0, 0, width, height ); // 在画布左上角绘制图片，并指定绘制宽度和高度
					$this.remove();
					...
					if ( data.beforeFunction != null ) data.beforeFunction();
