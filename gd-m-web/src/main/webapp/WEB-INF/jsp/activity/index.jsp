		...
		<div class="outline">
			...
			<div class="row">
				<div class="tab ">
					...
					<div id="tips_content" class="tips_content">
						<ul>
							<li>1、活动时间：6月21日-7月11日</li>
							<li>2、礼品兑换时间：6月21日-7月14日</li>
			...
			<div id="fingerPrint" class="finger_print bgLayer_out layerCont ">
				...
				<div class="fin_con bgLayerContent">
					...
					<!-- <div class="divCodeImg"><img class="codeImg" src="${CONTEXT}v1.0/images/qrcode_for_gh_73cba2400068_258.jpg" alt=""></div>-->
