...
<div class="header-t" style="width:100%; height:5rem; display: none; position:fixed; top:0; z-index:9999;background:rgba(0,0,0,0.7);">
      ...
      <div class="store clearfix">
      	   ...
      	   <div class="store-sp">
      	   	   <div class="store-left" dataId="4371">
      	   	   	   <div class="store-left-box">
      	   	   	      <div class="bg_rgba">主营分类：酒水</div>
      	   	   	      <img src="images/nsyimg/images/yulin_1.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	   <ul class="store-left-cet clearfix">
	      	   	   	      <li class="store-left-list1"></li>
	      	   	   	      <li class="store-left-list2">炎城商贸</li>
	      	   	   	      <li class="store-left-list3"></li>
	      	   	   	   </ul>
	      	   	   	</div>
      	   	   </div>
      	   	    <div class="store-right"  dataId="28120">
      	   	   	   <div class="store-right-box">
      	   	   	      <div class="bg_rgba">主营分类：粮油</div>
      	   	   	      <img src="images/nsyimg/images/yulin_2.jpg"/>
      	   	   	   </div>
      	   	   	  <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">湖北大米行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   	   <div class="store-left" dataId="4020">
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：海产</div>
      	   	   	     <img src="images/nsyimg/images/yulin_3.jpg"/>
      	   	   	   </div>
      	   	   	  <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">玉林泰好冷冻食品经营部</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right" dataId="24851" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：副食</div>
      	   	   	     <img src="images/nsyimg/images/yulin_4.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">广西宏盟生态农业有限公司</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   	   
      	   	   <div class="store-left" dataId="16108">
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：果蔬</div>
      	   	   	     <img src="images/nsyimg/images/yl_1.jpg"/>
      	   	   	   </div>
      	   	   	  <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">十二娘果业</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   <div class="store-right" dataId="4208" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/yl_2.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">健宏食用油商行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   	   
      	   	    <div class="store-left" dataId="33973">
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：副食</div>
      	   	   	     <img src="images/nsyimg/images/yl_3.jpg"/>
      	   	   	   </div>
      	   	   	  <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">饱芝零副食</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   <div class="store-right" dataId="4657" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：果蔬</div>
      	   	   	     <img src="images/nsyimg/images/yl_4.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">国庆果业</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   	   
      	   	    <div class="store-left" dataId="10484">
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：副食</div>
      	   	   	     <img src="images/nsyimg/images/yl_5.jpg"/>
      	   	   	   </div>
      	   	   	  <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">梁弟鲜蛋批发部</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   <div class="store-right" dataId="4007" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：副食</div>
      	   	   	     <img src="images/nsyimg/images/yl_6.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">陈琼冷冻食品经营部</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   ...
      	   <div class="gift-address">
      	   	   ...
      	   	   <div class="gift-address-sp">
      	   	   	  <p class="gift-sp"><i class="fillet"></i>&nbsp;玉林办事处</p>
      	   	   	  <p class="gift-addres-xq">地址：广西壮族自治区玉林市二环北路1222号玉林宏进农副产品批发市场1区1栋1号（办公楼5楼）<br/>
                                    联系人：张诗强 18907939330 &nbsp; &nbsp; &nbsp;李伍符 15977555593</p>
      	   	   </div>
      	   </div>
      </div>
      <!--底部-->
