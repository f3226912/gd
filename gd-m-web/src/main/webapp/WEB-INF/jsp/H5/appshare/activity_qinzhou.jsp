...
<div class="header-t" style="width:100%; height:5rem; display: none; position:fixed; top:0; z-index:9999;background:rgba(0,0,0,0.7);">
      ...
      <div class="store clearfix">
      	   ...
      	   <div class="store-sp">
      	   	   <div class="store-left" dataId="5883">
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：水果</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_1.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">永胜水果批发部</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right"  dataId="23182">
      	   	   	   <div class="store-right-box">
      	   	   	    <div class="bg_rgba">主营分类：水果</div>
      	   	   	    <img src="images/nsyimg/images/qinzhou_2.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">何七香蕉综合批发</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   	   <div class="store-left" dataId="5125">
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：水果</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_3.jpg"/>
      	   	   	    </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
      	   	   ...
      	   	   <div class="store-right"  dataId="5179" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：水果</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_5.jpg"/>
      	   	   	   </div>
      	   	   	  <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">平头菠萝批发行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   
      	   	  <div class="store-left" dataId="5538" >
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：蔬菜</div>
      	   	   	     <img src="images/nsyimg/images/cz_1.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">钦州鸿宇农业无公害蔬…</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   
      	   	    <div class="store-right"  dataId="5528" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_6.jpg"/>
      	   	   	   </div>
      	   	   	  <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">钦州宏航粮油贸易商行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   	   <div class="store-left"  dataId="5519" >
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_7.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">同佳粮油批发部</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right" dataId="5531" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_8.jpg"/>
      	   	   	   </div>
      	   	   	    <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">钦州松林粮油副食批发商行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   	   <div class="store-left" dataId="5525" >
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_9.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">钦州德行粮油贸易有限公司</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   
      	   	    <div class="store-right" dataId="5521" >
      	   	   	   <div class="store-right-box"> 
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_14.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">表姑粮油</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   	    ...
      	   	    <div class="store-left" dataId="5522" >
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_15.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">周三姐粮油</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right" dataId="17637" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：水产</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_16.jpg"/>
      	   	   	   </div>
      	   	   	  <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">钦州瑞邦水产</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	</div>
      	   	   </div>
      	   	   
      	   	    <div class="store-left" dataId="10536" >
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：蔬菜</div>
      	   	   	     <img src="images/nsyimg/images/qinzhou_17.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">渝桂亨通贸易</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   ...
      	   <div class="gift-address">
      	   	   ...
      	   	   <div class="gift-address-sp">
      	   	   	  <p class="gift-sp"><i class="fillet"></i>&nbsp;钦州办事处</p>
      	   	   	  <p class="gift-addres-xq">地址：广西壮族自治区钦州市金海湾西大街1222号中国东盟农产品大市场A9-3-3楼<br/>
                                    联系人：彭瑛 13217730110 &nbsp; &nbsp; &nbsp;唐国祥 15778761816</p>
      	   	   </div>
      	   </div>
      </div>
      <!--底部-->
		...
		//倒计时
	        function getRTime() {
	        	...
	        	if(t>=0){
	                ...
	                document.querySelector('.li-time-t').innerHTML = d;
	                document.querySelector('.li-time-h').innerHTML = h;
	                document.querySelector('.li-time-m').innerHTML = m;
	                document.querySelector('.li-time-s').innerHTML = s;    
