...
<div class="header-t" style="width:100%; height:5rem; display: none; position:fixed; top:0; z-index:9999;background:rgba(0,0,0,0.7);">
      ...
      <div class="store clearfix">
      	   ...
      	   <div class="store-sp">
      	   	   <div class="store-left" dataId="12323">
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：干调</div>
      	   	   	     <img src="images/nsyimg/images/luoyang_1.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">启武干调辣椒商</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right"  dataId="13455">
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/luoyang_2.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">侠福豆制品商行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   <div class="store-left" dataId="11573">
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/luoyang_3.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">利鑫粉业</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right" dataId="11127" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/luoyang_4.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">双龙干果粉条批发行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   <div class="store-left"  dataId="9158" >
      	   	   	   <div class="store-left-box">
      	   	   	      <div class="bg_rgba">主营分类：干调</div>
      	   	   	      <img src="images/nsyimg/images/luoyang_5.jpg"/>
      	   	   	    </div>
      	   	   	  <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">国旗干果批发行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right"  dataId="8416" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：干调</div>
      	   	   	     <img src="images/nsyimg/images/luoyang_6.jpg"/>
      	   	   	    </div>
      	   	   	  <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">伟伟大枣干果商行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   <div class="store-left"  dataId="8407" >
      	   	   	   <div class="store-left-box">
      	   	   	      <div class="bg_rgba">主营分类：干调</div>
      	   	   	      <img src="images/nsyimg/images/luoyang_7.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">文国干调辣椒商行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right" dataId="8696" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/luoyang_8.jpg"/>
      	   	   	   </div>
      	   	   	    <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">老冯粮行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	   <div class="store-left" dataId="32096" >
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：粮油</div>
      	   	   	     <img src="images/nsyimg/images/luoyang_9.jpg"/>
      	   	   	   </div>
      	   	   	  <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">金诚粮行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right" dataId="30524" >
      	   	   	   <div class="store-right-box">
      	   	   	      <div class="bg_rgba">主营分类：冻品</div>
      	   	   	      <img src="images/nsyimg/images/luoyang_10.jpg"/>
      	   	   	    </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">马三萍牛羊肉调理商贸</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-left" dataId="32721" >
      	   	   	   <div class="store-left-box">
      	   	   	     <div class="bg_rgba">主营分类：冻品</div>
      	   	   	     <img src="images/nsyimg/images/luoyang_11.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-left-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">众品冷鲜肉</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   	    <div class="store-right" dataId="32398" >
      	   	   	   <div class="store-right-box">
      	   	   	     <div class="bg_rgba">主营分类：冻品</div>
      	   	   	     <img src="images/nsyimg/images/luoyang_12.jpg"/>
      	   	   	   </div>
      	   	   	   <div class="store-right-name">
	      	   	   	      <ul class="store-left-cet clearfix">
	      	   	   	        <li class="store-left-list1"></li>
	      	   	   	        <li class="store-left-list2">洛阳市鑫达海鲜副食商行</li>
	      	   	   	        <li class="store-left-list3"></li>
	      	   	   	      </ul>
	      	   	   	  </div>
      	   	   </div>
      	   ...
      	   <div class="gift-address">
      	   	   ...
      	   	   <div class="gift-address-sp">
      	   	   	  <p class="gift-sp"><i class="fillet"></i>&nbsp;洛阳办事处</p>
      	   	   	  <p class="gift-addres-xq">地址：洛阳市老城区邙山镇310国道与定鼎北路交叉口北300米洛阳宏进农产品批发市场招商中心2楼<br/>
                                    联系人：杨依勇 13949121953 &nbsp; &nbsp; &nbsp;吕伟 15038532033</p>
      	   	   </div>
      	   </div>
      </div>
      <!--底部-->
