...
<div class="header-t" style="width:100%; height:5rem; display: none; position:fixed; top:0; z-index:9999;background:rgba(0,0,0,0.7);">
       ...
       <div class="top-activity">
       	  <div class="banner">
       	  	<img src="images/nsyimg/images/kaifeng.png">
       	  </div>
          <!-- 倒计时 -->
          <div class="countdown">
      ...
      <div class="store clearfix">
      	   ...
      	   <div class="store-sp"  dataId="33785">
      	       <div class="store-sp-cl">主营分类：干粮、粮油</div>
      	   	   <div class="kai_feng"><img src="images/nsyimg/images/kf_img.png"/></div>
      	   </div>
      	   <div class="gift-address">
      	   	   <p class="gift-img"><img src="images/nsyimg/images/address.png"/></p>
      	   	   <div class="gift-address-sp">
      	   	   	  <p class="gift-sp"><i class="fillet"></i>&nbsp;开封办事处</p>
      	   	   	  <p class="gift-addres-xq">地址：开封市禹王台区310国道芦花岗转盘东2公里，开封宏进农副产品国际物流中心C区C14--24<br/>
                                    联系人：丁广信 13733838485 &nbsp; &nbsp; &nbsp;刘举 15637808808</p>
      	   	   </div>
      	   </div>
      </div>
      <!--底部-->
