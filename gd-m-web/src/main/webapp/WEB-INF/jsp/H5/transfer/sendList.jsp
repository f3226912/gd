...
<html>
	<head>
		...
		<script type="text/javascript" src="${CONTEXT }js/transfer/sendList.js?v=2.1"></script>
		<script type="text/javascript" src="${CONTEXT }js/transfer/nstList.js?v=2.2"></script>
	</head>
<body>
