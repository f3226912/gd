    ...
    */
	...
	if(document.getElementById('cont-more2')!=null) {
		document.getElementById('cont-more2').addEventListener('tap', function() {
			if (!mui.os.plus) {
				mui.openWindow({
					url: "${CONTEXT }transferDetail/${mem.id }/${mem.supplySourceType}/${mem.source}?fromCode=${fromCode}&memberId=${userId}&c=${c}&pa=showufTranDetail&orderNo=${orderNo}&nobId=${mem.nobId}&source=${mem.source}",
					id: "cont-more2",
					show: {
