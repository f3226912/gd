						...
						success:function(data){
		     				...
		     				if (data && data.length>0){
								...
								firstreq+=1;
		     					...
		     					if(firstreq==0){
			 						$("body").append('<div style="position: absolute;width:100%;height: 100%;z-index:9;"><div style="top:50%;margin-top: -2rem;position: relative; "><a id="icon-chatbubble" style="color: #8F8F94;"><span class="mui-icon" style="position: absolute;top:-10.5rem; left:50%; margin-left:-8rem;"><img style="width:16rem; height:11.9rem;" src="${CONTEXT}v1.0/images/blank_box.png"/></span><span style="width: 100%; text-align: center;position: absolute; top:2.5rem; font-size: 1.5rem;">暂无消息</span></a></div></div>');
