...
<html>
	...
	<body>
		<div class="left-arrow" id="left">
			<img src="${CONTEXT }/v1.0/images/data/leftArrow.png" alt="">
		</div>
		<div id="right" class="right-arrow">
			<img src="${CONTEXT }/v1.0/images/data/rightArrow.png" alt="">
		</div>
			...
			<div class="swiper-container">
				<div class="swiper-wrapper trans-time">
					<div class="swiper-slide">
						<article class="row">
							<img class="top-trade" src="${CONTEXT }/v1.0/images/data/tradeBackground.png" alt="">
							<section id="trade-num-tip" class="trade-num-tip">
								<img src="${CONTEXT }/v1.0/images/data/tradeAmount.png" alt="" class="trade-num-pic">
						...
						<article class="row">
							...
							<div class="ratio-sit"> 已收款交易额占比情况</div>	
					...
					<div class="swiper-slide">
						<article class="row">
							...
							<section class="trade-num-tip">
								<img src="${CONTEXT }/v1.0/images/data/orderNum.png" alt="" class="trade-num-pic">
								<div class="trade-num-words">
		...
		<script src="${CONTEXT }/v1.0/js/data/swiper.min.js"></script>
		<script src="${CONTEXT }/v1.0/js/echartsPiesmin.js"></script>
