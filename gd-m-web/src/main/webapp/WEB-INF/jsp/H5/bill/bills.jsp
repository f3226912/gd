...
<head>
	...
	<style>
		...
		.tit-date{ height: 3.1rem; line-height: 3.1rem; background: #f0f0f0; font-size: 1.2rem; width: 100%; float: left;}
...
<body>	
	<div class="main-wrap">
        <p style="font-size:1.3rem; color:#666; padding: 1rem 0 .5rem 1.5rem; ">温馨提示：本页面只显示上线后的账单!</p>
		<div class="tit-date">
...
$(document).ready(function(){
	var myDate = new Date();
	var myFull = myDate.getFullYear()+'年';
		...
		$.ajax({
		    ...
		    data: datas,
		   	success: function(data){
		   		...
		   		if (!dataList) {
		   			$('.bill-date-day').find('.bill-date-list').html('');
