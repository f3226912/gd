	    ...
	    success: function(data) {
	    	...
	    	if(data.statusCode==0) {
	    		...
	    		$(data.object.pageData).each(function(i,v) {
	    			...
	    			case 1:
	    				link= CONTEXT+"transfer/showWfTranDetail/"+v.nobId+"/"+fromCode+"?c=1&userId="+userId+"&source="+v.source;
	    				break;
	    			case 2:
	    				link= CONTEXT+"transfer/showFTranDetail/"+v.nobId+"/"+fromCode+"?c=1&userId="+userId+"&source="+v.source;
	    				break;
	    			case 3:
	    				link= CONTEXT+"transfer/showFoTranDetail/"+v.nobId+"/"+fromCode+"?c=1&userId="+userId+"&source="+v.source;
	    				break;
	    			case 4:
	    				link= CONTEXT+"transfer/showufTranDetail/"+v.nobId+"/"+fromCode+"?c=1&userId="+userId+"&source="+v.source;
	    				break;
	    			case 5:
	    				link= CONTEXT+"transfer/showufTranDetail/"+v.nobId+"/"+fromCode+"?c=1&userId="+userId+"&source="+v.source;
	    				break;
