package com.gudeng.commerce.gd.m.controller.marketing;
...
@Controller
@RequestMapping("PromotionAcitivity")
public class PromotionAcitivityController extends MBaseController{
	...
	public String showDetail(HttpServletRequest request, HttpServletResponse response)
		...
		//System.out.println("redirect:" + PathUtil.getBasePath(request) + "gys-detail.html");
		//return "redirect:" + PathUtil.getBasePath(request) + "gys-detail.html";
		return "H5/marketing/gys-detail";
	}
	...
	public String promotionDetail(HttpServletRequest request, HttpServletResponse response)
		...
		//System.out.println("redirect:" + PathUtil.getBasePath(request) + "gys-detail.html");
		//return "redirect:" + PathUtil.getBasePath(request) + "gys-detail.html";
		return "H5/marketing/cxh-details";
	}
