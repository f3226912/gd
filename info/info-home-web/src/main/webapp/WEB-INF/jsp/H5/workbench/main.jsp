...
<html>
	...
	<body>
		<header class="mui-bar mui-bar-nav">
			<a class="mui-icon mui-pull-left">${systemLoginUser.userName }  [${systemLoginUser.orgUnitId }]</a>
			<a id="info" class="mui-icon mui-icon-info-abort mui-pull-right">退出</a>
