...
import com.gudeng.commerce.info.admin.dto.TreeNode;
...
import com.gudeng.commerce.info.customer.entity.SysRightBtn;
...
public class SysMenuController extends AdminBaseController {
    ...
    /** 按钮service */
    @Autowired
    private SysMenuButtonAdminService sysMenuButtonService;
    ...
    public ModelAndView addInit(HttpServletRequest request) {
        ...
        if (baseMenuList != null && baseMenuList.size() > 0) {
            Iterator<SysMenu> itr = baseMenuList.iterator();
            while (itr.hasNext()) {
