 ...
 */
@Component
public class OrderNumberReportCommand extends ReportBaseCommand{
		...
		try{
			...
			for (String dateStr : dateStrList) {
				...
				if (dto == null) {
					...
					dataList.add(dto.getOrderNumbers());
				}
			}
			...
			dataDetailDTO.setColor(ReportsUtil.Color.ORANGE.value());
			dataDetailDTO.setParms("日订单量");
