...
import com.gudeng.commerce.gd.customer.util.IdGenerateUtil;
import com.gudeng.framework.page.HessianQueryParamUtil;
...
public class AppVersionServiceImpl implements AppVersionService{
	...
	@Override
	public AppVersion getLastAppVersionByMap(Map<String,Object> map) {
		return (AppVersion) this.baseDao.queryForObject("AppRecord.getLastAppVersionByMap", map, AppVersion.class);
	}
