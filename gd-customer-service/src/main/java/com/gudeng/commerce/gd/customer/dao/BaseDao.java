package com.gudeng.commerce.gd.customer.dao;
...
public interface BaseDao<T> {
	...
	/** 返回requiredType类型对象List集合，不需要强转 */
	<E> List<E> queryForListByCall(Class<E> elementType ,String proName,Object... param);
	
	/**  返回requiredType类型对象List集合，不需要强转 */
	<E> E queryForObjectByCall(Class<E> elementType ,String proName,Object... param);
