package com.gudeng.commerce.gd.customer.dao.impl;
...
public class BaseDaoImpl<T> implements BaseDao<T> {
    ...
    public static final String PROCEDURE="Procedure.callProcedure";
    ...
    @Override
    public <E> List<E> queryForListByCall(Class<E> elementType ,String proName,Object... params) {
    	...
    	return dalClient.queryForList(PROCEDURE, paramMap, elementType);
    }

	@Override
	public <E> E queryForObjectByCall(Class<E> elementType, String proName, Object... params) {
		StringBuffer sb = new StringBuffer();
    	sb.append(" call ");
    	sb.append(proName);
    	sb.append("(");
    	...
    	Map<String, String> paramMap = new HashMap<>();
    	 paramMap.put("sql", sb.toString());
    	 System.out.println("call------------>"+sb.toString());
		return dalClient.queryForObject(PROCEDURE, paramMap, elementType);
	}
