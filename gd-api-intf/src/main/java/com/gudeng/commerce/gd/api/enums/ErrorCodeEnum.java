...
public enum ErrorCodeEnum {
	...
	PAY_CENTER_API_FAIL(-10001, "支付中心服务器繁忙，请稍后重试"),
	
	PRO_CODE_OLD(-10002,"二维码已失效"),
	PRO_ORDER_ISCONFIRM(-10003,"此订单已确认！"),
	
	PRO_ORDER_NOTActivityType(-10003,"此订单未参加现场采销活动！"),
	...
	BUYERCOMSN_NOT_CORRECT(-1,"买家佣金不等于市场佣金和平台佣金"),
	
	PUBLISH_ORDER_RESOURCE_ERROR(-1,"发布货源信息异常"),
	//商品相关 start
	PRODUCT_ID_IS_NULL(-1, "商品id不能为空"),
	/** 库存为0  */
	PRODUCT_NO_STOCK_COUNT(-5, "您购买的部分商品卖完了，请您刷新商品后重新提交"),
	...
	PRODUCT_PRICE_CHANGED(-1, "商品价格已经变更, 请刷新页面重新下单"),
	...
	ALREADY_HAS_GOLD_MEDAL(-1, "该用户已经是金牌会员"),
	//用户相关 end
	...
	NOT_ANY_CERTIFIED(-1, "还未通过任何身份认证，请填写身份认证信息"),
	NOT_CERTIFIED(-1, "未通过认证，请到我的认证完善认证信息"),
	...
	ORDER_BUSINESS_INFO_IS_NULL(-1, "订单商铺信息不能为空"),
	
	ORDER_PRODUCT_INFO_IS_NULL(-1, "订单商品信息不能为空"),
	
	ORDER_ADDRESS_INFO_IS_NULL(-1, "收货地址信息不能为空"),
	...
	ORDER_AMOUNT_IS_NULL(-1, "订单金额不能为空或小于0"),
	...
	ORDER_PAY_INFO_OVER_LENGTH(-1, "上传凭证图片不能多过" + Order.MAX_IMAGE_NUM + "张"),
	
	ORDER_PAYSERIAL_NOT_EXISTED(-1, "订单支付流水不存在"),
	
	ORDER_COMMISSION_ERROR(-1, "您购买商品所需支付的商家佣金金额大于商家货款实收金额, 请重新操作"),
	
	ORDER_RECEIPT_CITY_IS_NULL(-1, "订单收货地不能为空"),
	//订单相关错误码 end
	...
	PROM_ACT_ENDED(-1, "您购买的商品所参与的活动已变更, 请刷新页面重新下单"),
	...
	TYPE_ID_IS_NULL(-1,"查询类型不能为空"),
	OPERATOR_NAME_IS_NULL(-1,"实体商铺经营者的姓名不能为空"),
	BUSINESS_ADDRESS_IS_NULL(-1,"商铺地址不能为空"),
	CONTRACT_IMG_IS_NULL(-1,"租赁合同照片"),
	NO_CERTIFI(-1,"未提交认证"),
	CERTIFI_EXIST(-1,"您已经存在一条认证记录了, 请勿重复添加"),
	OPERATORNAME_TOO_LOON(-1,"实体商铺经营者的姓名太长"),
	REALSHOPNAME_TOO_LOON(-1,"线下实体商铺名称太长"),
	
	
	CART_QUANTITY_IS_NULL(-1,"商品数量必须大于0"),
	
	CART_PRODUCT_NOT_EXIST(-1,"商品不存在"),
	
	CART_ADD_PRODUCT_SUCCESS(0,"加入购物车成功"),
	
	CART_ADD_PRODUCT_FAIL(-1,"加入购物车失败"),
	
	CART_PRICE_IS_NULL(-1, "商品金额不能为空或0"),
	
	CART_PRODUCT_NOT_ONSALE(-1, "只能操作销售中的产品"),
	
	CART_NO_STOCK_COUNT(-1, "商品已售馨, 请您刷新商品后重新购买"),
	
	CART_DELETE_PRODUCT_SUCCESS(0,"商品从购物车中删除成功"),
	
	CART_DELETE_PRODUCT_FAIL(-1,"商品从购物车中删除失败"),
	
	CART_MODIFY_PARAM_NULL(-1,"商品更新参数为空"),
	
	CART_SHOPPINGITEMID_IS_NULL(-1,"购物项id为空"),
	
	CART_MODIFY_PRODUCT_SUCCESS(0,"修改成功"),
	
	CART_MODIFY_PRODUCT_FAIL(-1,"修改失败"),
	
	CART_PRODUCTID_IS_NULL(-1,"商品ID为空"),
	
	ORDER_CALLBACK_ORDERNO_IS_NULL(-1,"货源ID为空"),
	ORDER_CALLBACK_TYPE_IS_NULL(-1,"类型为空"),
	ORDER_CALLBACK_REASON_IS_NULL(-1,"取消原因为空"),
	ORDER_CALLBACK_USER_IS_NULL(-1,"操作人为空"),
	ORDER_CALLBACK_STATUS_IS_NULL(-1,"状态为空"),
	ORDER_CALLBACK_SUCCESS(0,"更新成功"),
	ORDER_CALLBACK_FAIL(-1,"更新失败"),
	OFFERPRICE_FAIL(-1,"请确认金额"),
	SIZE_FAIL(-1,"请确认采购量"),
    OFFERPRICE_REMARK_FAIL(-1,"请确认备注信息"),
    OFFERPRICE_COUNT_FAIL(-1,"该信息您已报价"),
	NPSPURCHASE_UPDATE_FAIL(-1,"操作失败请确认采购信息状态");
