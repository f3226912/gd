...
public class Validator {
    ...
    public static final String REGEX_MOBILE = "^((13[0-9])|(15[^4\\D])|(14[57])|(17[0-9])|(18[0,0-9]))\\d{8}$";
    /**
     * 正则表达式：验证邮箱
     */
     ...
     * 正则表达式：验证汉字+英文+数字
     */
    public static final String REGEX_CHINESE_ENGLISH_NUMBER = "^[a-zA-Z0-9\u4E00-\u9FA5]+$";
     ...
     * @return 校验通过返回true，否则返回false
     */
    public static boolean isChineseEnglishNumber(String string) {
        return Pattern.matches(REGEX_CHINESE_ENGLISH_NUMBER, string);
    }
