...
//		}
	 ...
	 * @return
	 */
	public static String formatMoneyWithZero(Double money) {
		return formatMoneyWithZero(money, null);
	}
	 ...
	 * @return
	 */
	public static String formatMoneyWithZero(Double money, DecimalFormat df) {
		String retString="";
