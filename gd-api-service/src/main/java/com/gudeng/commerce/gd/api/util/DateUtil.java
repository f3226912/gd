...
public class DateUtil  extends DateUtils {
	...
	/**
	 * 要用到的DATE Format的定义[MM-dd]
	 */
	public static final String DATE_FORMAT_MONTH_AND_DAY = "MM-dd";
	...
	public static void main(String[] args) {
		String dateStr = "2016-07-05 02:50:00";
		//System.out.println(DateUtil.getNow());
		int interval = (int) (getBetweenDays(getDate(dateStr, DATE_FORMAT_DATEONLY), new Date()) - 7);
		System.out.println(String.format("%04d", getWeek()));
	}
}
