package com.gudeng.commerce.gd.admin.dto.sysmgr;
...
/**
 * @Description easyUI节点事件
 * @Project gd-admin-intf
 * @ClassName EventNode.java
 * @Author lidong(dli@gdeng.cn)
 * @CreationDate 2016年1月14日 上午8:28:05
 * @Version V2.0
 * @Copyright 谷登科技 2015-2015
 * @ModificationHistory
 */
public class EventNode implements Serializable {
    private static final long serialVersionUID = -588615076421127415L;
    private String id;
    private String text;
