...
public class ProductParamsBean{
	...
	private String originPlaceSwitch;
	...
	public String getOriginPlaceSwitch() {
		return originPlaceSwitch;
	}

	public void setOriginPlaceSwitch(String originPlaceSwitch) {
		this.originPlaceSwitch = originPlaceSwitch;
	}
	/**
	 * 产地-省
	 */
