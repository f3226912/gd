...
//	private final static String encodeKey = "s1f2d3s4)5&6f7f8#9s0#1@2";
//	private final static String encodeIv = "20151009"; 
	...
	public static void main(String[] args) throws Exception {
		/*List<ProductMDTO> list1 = new ArrayList<ProductMDTO>();
		Gson gson = GSONUtils.getGson();
		ProductMDTO dd = new ProductMDTO();
		dd.setId("004457");
		dd.setQuantity(2);
		list1.add(dd);
		String text = encode(gson.toJson(list1));
		System.out.println(text);
		System.out.println(URLEncoder.encode(text, "utf-8"));
		Type type = new TypeToken<List<ProductMDTO>>() {}.getType();
		gson.fromJson(Des3Request.decode(text), type);*/
	}
