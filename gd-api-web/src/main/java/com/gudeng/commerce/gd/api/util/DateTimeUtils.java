...
public class DateTimeUtils {
	...
	*/
	public static void main(String[] args) {
		...
		System.out.println(DateTimeUtils.getTimeBetween(DateUtil.formateDate("2015-12-09 11:20:00",  DateUtil.sdfDateTime)));
		//System.out.println();
