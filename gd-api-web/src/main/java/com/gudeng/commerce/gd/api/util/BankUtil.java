...
//		String cardNumber = "6210676802084484923";//卡号
		String cardNumber = "6222 6213 1001 0636 617";//卡号
		String name = getNameOfBank(cardNumber);
		System.out.println(name);
		
//		System.out.println(bankBin.length);
//		System.out.println(bankName.length);
//		for(int i=0, len=bankBin.length; i<len;i++){
//			System.out.println(bankBin[i] + "   " + bankName[i]);
//		}
	}
	...
	"623251", "628351", "622992", "623133", "625121", "628330"
	};
	...
	private static final String[] bankName = { 
	 ...
	 "玉溪市商业银行·红塔卡", "广西农村信用社·借记卡", "广西农村信用社·借记卡", "广西农村信用社·桂盛信用卡", "广西农村信用社·桂盛公务卡"
	};
}
