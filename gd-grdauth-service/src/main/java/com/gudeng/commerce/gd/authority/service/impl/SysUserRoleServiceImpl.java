...
public class SysUserRoleServiceImpl implements SysUserRoleService {
	...
	public SysUserRole get(String userID) {
		...
		map.put("userID", userID);
		return baseDao
				.queryForObject("SysUserRole.get", map, SysUserRole.class);
	}

	@Override
	public List<SysUserRole> getByCondition(Map<String, Object> map) {
		// return sysUserRoleMapper.getByCondition(map);
		List<SysUserRole> list = baseDao.queryForList(
				"SysUserRole.getByCondition", map, SysUserRole.class);
		return list;
	}
	...
	public List<SysUserRole> getListSysUserRole(Map<String, Object> map) {
		...
		List<SysUserRole> list = baseDao.queryForList("SysUserRole.getAll",
				map, SysUserRole.class);
		return list;
	}
	...
	public Integer getTotal(Map<String, Object> map) {
		...
		return (int) baseDao.queryForObject("SysUserRole.getTotal", map,
				Integer.class);
	}
	...
	@Override
	public void insertBatch(String userIDs, String roleID, String createUserID)
			throws Exception {
		Map<String, Object> map = new HashMap<String, Object>();
	...
	public List<SysUserRole> getUserRoleList(Map<String, Object> map) {
		...
		List<SysUserRole> list = baseDao.queryForList(
				"SysUserRole.getUserRoleList", map, SysUserRole.class);
		return list;
	}

	@Override
	public List<SysUserRole> getSysUserList(Map<String, Object> map)
			throws Exception {
		// return sysUserRoleMapper.getSysUserList(map);
		List<SysUserRole> list = baseDao.queryForList(
				"SysUserRole.getSysUserList", map, SysUserRole.class);
		return list;
	}
	...
	public List<SysUserRole> getUserAllRoleList(Map<String, Object> map) {
		// return sysUserRoleMapper.getUserAllRoleList(map);
		List<SysUserRole> list = baseDao.queryForList(
				"SysUserRole.getUserAllRoleList", map, SysUserRole.class);
		return list;
	}

	@Override
	public int getUserAllRoleCount(Map<String, Object> map) {
//		return sysUserRoleMapper.getUserAllRoleCount(map);
		return (int)baseDao.queryForObject("SysUserRole.getUserAllRoleCount", map,Integer.class);
	}

	@Override
	public void insertUserRoleBatch(String userID, String roleIDs,
